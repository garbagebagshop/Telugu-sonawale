...
const PriceRow: React.FC<{ title: string; price: number; trend: string }> = ({ 
  ...
  <div className="flex justify-between items-center py-4 border-b border-black/10 last:border-0">
    <div>
    ...
    <div className="text-right">
      ...
      <p className="text-[9px] font-bold opacity-40 mt-1">PER 10G</p>
    </div>
  </div>
);
    ...
    <div className="border-y-2 border-black divide-y divide-black/10">
      ...
      <div className="flex justify-between items-center py-4 border-b border-black/10 last:border-0">
        ...
        <div className="text-right">
          ...
          <p className="text-[9px] font-bold opacity-40 mt-1">PER 1KG</p>
        </div>
      </div>
    </div>
  );
