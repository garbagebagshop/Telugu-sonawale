...
import { HYDERABAD_MARKET_AVERAGES, AUTHORS, GUIDES as INITIAL_GUIDES } from './constants.ts';
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const schema = {
      ...
      "@type": "LocalBusiness",
      "name": "Sonawale Hyderabad Bullion Registry",
      "image": "https://sonawale.com/logo.png",
      "@id": "https://sonawale.com",
      "url": "https://sonawale.com",
      "telephone": "+918886575507",
      "priceRange": "₹₹₹",
      "address": {
        "@type": "PostalAddress",
        "streetAddress": "Abids Road",
  ...
  return (
    <div className="min-h-screen flex flex-col max-w-[1400px] mx-auto bg-[#F4F1EA] md:border-x border-black/20 overflow-x-hidden">
      ...
      <header className="py-8 px-4 text-center mx-auto w-full max-w-4xl cursor-pointer" onClick={() => setCurrentPage(null)}>
        <div className="flex justify-between items-end text-[9px] md:text-[10px] font-black uppercase tracking-[0.1em] md:tracking-[0.2em] mb-4 border-b-2 border-black pb-1 utility-font">
        ...
        <p className="text-[9px] sm:text-[10px] font-black tracking-[0.2em] sm:tracking-[0.6em] uppercase opacity-70 utility-font telugu-text max-w-xs mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 animate-in fade-in duration-500">
            <article className="lg:col-span-8 space-y-10" itemScope itemType="https://schema.org/NewsArticle">
              ...
              <section className="border-b-[3px] border-black pb-10">
                ...
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-[1.15] mb-6 telugu-headline" itemProp="headline">
                  రెండవ త్రైమాసికంలో భారీగా పెరగనున్న బంగారం దిగుమతులు: హైదరాబాద్ వ్యాపారుల అంచనా
                </h2>
                <div className="flex flex-wrap items-center gap-3 sm:gap-4 text-xs font-bold mb-8 italic opacity-70 telugu-text border-l-2 border-black/10 pl-4">
                ...
                <div itemProp="articleBody" className="telugu-text">
                  <p className="text-xl leading-relaxed text-gray-900 first-letter:text-7xl sm:first-letter:text-8xl first-letter:font-black first-letter:mr-3 first-letter:float-left first-letter:leading-[0.7] first-letter:font-serif first-letter:text-black">
            ...
            <aside className="lg:col-span-4 lg:border-l lg:border-black/20 lg:pl-8 space-y-12">
              <div className="sticky top-12 space-y-12">
                <section aria-labelledby="market-summary-heading">
                  ...
                  <p className="text-[9px] mt-3 font-bold opacity-50 utility-font uppercase telugu-text text-center tracking-widest">చివరి అప్డేట్: {prices.lastUpdated}</p>
                </section>
                ...
                <div className="p-6 border-2 border-dotted border-black bg-white/40 group">
                  <h4 className="text-[11px] font-black uppercase mb-3 utility-font telugu-text font-bold text-center">రిపోర్టర్ పోర్టల్</h4>
                  <p className="text-[13px] leading-relaxed opacity-80 telugu-text mb-6 text-center italic">
      ...
      <footer className="mt-auto border-t-2 border-black mx-4 py-12 bg-[#F4F1EA]">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 mb-12 telugu-text">
          <div className="md:col-span-1">
            ...
            <p className="text-[15px] opacity-90 leading-relaxed italic">
              హైదరాబాద్ మరియు తెలంగాణా ప్రాంతంలో అత్యంత విశ్వసనీయమైన బులియన్ మరియు మార్కెట్ వార్తా సంస్థ. మేము పారదర్శకత మరియు ఖచ్చితమైన సమాచారానికి కట్టుబడి ఉన్నాము.
            </p>
          </div>
          <div>
        ...
        <div className="pt-8 border-t border-black/20 text-center text-[10px] font-black uppercase tracking-[0.3em] utility-font opacity-60">
